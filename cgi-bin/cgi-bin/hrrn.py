...
<html>
   ...
   <p> Run Log </p>
   <iframe name="Iframe1" frameborder="0" scrolling="no" width=100% onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" src="/srt_out_show.txt"> </iframe> 
...
if __name__ == '__main__':
   ...
   <title> Sucess </title>
    ...
    #Html output end
    html += "</body></html>"
    html_show = open('../pi/srt_html_show.html', 'w')
