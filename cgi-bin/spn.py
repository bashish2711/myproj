#!/usr/bin/python
#Shortest Process Next scheduling implementation
...
<html>
   ...
   <a href=/spn_html_show.html target=_new> HTML Gantt Chart </a>
   <a href=/spn_out_show.txt target=_new> Text Log File </a>
   <p> Gantt Chart </p>
   ...
   <p> Run Log </p>
   <iframe name="Iframe1" frameborder="0" scrolling="no" width=100% onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" src="/spn_out_show.txt"> </iframe> 
...
if __name__ == '__main__':
   ...
   <title> Sucess </title>
    ...
    #Html output end
    html += "</body></html>"
    html_show = open('../pi/spn_html_show.html', 'w')
