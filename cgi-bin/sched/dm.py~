...
<html>
   ...
   <a href=/simout/dm_html_show.html target=_new> HTML Gantt Chart </a> <br> 
   <a href=/simout/dm_out_show.txt target=_new> Text Log File </a>
   <p> Gantt Chart </p>
   <iframe name="Iframe2" frameborder="0" scrolling="no" width=100% onload="this.style.height=this.contentDocument.body.scrollHeight+20 +'px';" src="/simout/dm_html_show.html" > </iframe>
   <p> Run Log </p>
   <iframe name="Iframe1" frameborder="0" scrolling="no" width=100% onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" src="/simout/dm_out_show.txt"> </iframe> 
...
if __name__ == '__main__':
   ...
   <title> Sucess </title>
    ...
    #Html output end
    html += "</body></html>"
    html_show = open('../pi/simout/dm_html_show.html', 'w')
    html_show.write(html)
    html_show.close()
    out_show = open('../pi/simout/dm_out_show.txt', 'w')
    out_show.write(out)
    out_show.close()
